...
UPDATE `mangos_string` SET `content_loc3` = 'Grüner Smaragd' where entry = 20007;
...
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum Raum des alten Schreins wurde zerstört!' where entry = 20036;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum grünen Smaragd wurde zerstört!' where entry = 20037;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum blauen Saphir wurde zerstört!' where entry = 20038;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum violetten Amethyst wurde zerstört!' where entry = 20039;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zur roten Sonne wurde zerstört!' where entry = 20040;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum gelben Mond wurde zerstört!' where entry = 20041;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum Raum des alten Schreins wurde beschädigt!' where entry = 20042;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum grünen Smaragd wurde beschädigt!' where entry = 20043;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum blauen Saphir wurde beschädigt!' where entry = 20044;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum violetten Amethyst wurde beschädigt!' where entry = 20045;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zur roten Sonne wurde beschädigt!' where entry = 20046;
UPDATE `mangos_string` SET `content_loc3` = 'Das Tor zum gelben Mond wurde beschädigt!' where entry = 20047;
